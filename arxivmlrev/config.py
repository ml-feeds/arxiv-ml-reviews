...
CONFIG_ARTICLES = pd.read_csv(CONFIG_DIR / 'articles.csv', dtype={'URL_ID': str})
...
URL_ID_BLACKLIST = set(CONFIG_ARTICLES[CONFIG_ARTICLES['State'] == 0]['URL_ID'])
URL_ID_WHITELIST = set(CONFIG_ARTICLES[CONFIG_ARTICLES['State'] == 1]['URL_ID'])
